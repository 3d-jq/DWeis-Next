---
name: browser
description: Use DWeis's visible integrated browser to inspect and interact with web pages.
icon: ":lucide:search:"
---
...
- Use the integrated browser for visual or stateful page interaction, including navigation, forms,
  controls, client-rendered content, and the user's existing DWeis browser session.
- Operate only through DWeis's `browser_*` tools. Do not start a separate browser automation
  process.

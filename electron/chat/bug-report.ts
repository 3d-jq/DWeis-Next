...
export function buildBugReportSystemPrompt(options: {
  ...
  return [
    ...
    "- The user invoked DWeis's built-in /bug-report command. Produce a developer-ready bug report from the conversation context that existed before this command.",
    ...
    `- ${branding.appName} version: ${runtime.appVersion}`,

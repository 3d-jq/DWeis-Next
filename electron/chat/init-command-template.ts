/**
 * /init 斜杠命令的模板文本：用户消息保持命令名（/命令），由主进程把模板作为 system 指令注入 agent，
 * agent 会调研当前项目并创建或更新 AGENTS.md（对应 opencode 的 /init 内置命令）。
 */
export const initCommandTemplate = `Create or update AGENTS.md for this repository.

...
export function isMacPlatform(platform: NodeJS.Platform | undefined = globalThis.dweisnext?.platform): boolean {
  return platform === "darwin"
}

export function appCommandForKeyboardShortcut(
  event: KeyboardShortcutEvent,
  platform: NodeJS.Platform | undefined = globalThis.dweisnext?.platform,
): AppCommand | null {

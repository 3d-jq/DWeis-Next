import type { ManagedSkillGroup, ManagedSkillHostCoverage } from "../../../electron/skills/common.ts"
    ...
    <div className="flex min-w-0 flex-col gap-3">
      <InspectorCard className="shrink-0">
        <CardHeader className="grid gap-1 px-3 py-0">
          ...
          {packageLine ? <CardDescription className="min-w-0 truncate">{packageLine}</CardDescription> : null}
        </CardHeader>

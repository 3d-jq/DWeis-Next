  ...
  const refreshArchived = React.useCallback(
    async (options: { showLoading?: boolean } = {}) => {
      ...
      try {
        ...
        console.error("[dweis] list archived sessions failed", cause)
    ...
    >
      ...
      <section className="overflow-hidden rounded-md border border-[var(--oo-divider)] bg-background">
        <div className="grid grid-cols-[minmax(16rem,1fr)_auto] gap-3 border-b border-[var(--oo-divider)] p-3 max-[760px]:grid-cols-1">
          <div className="flex h-10 min-w-0 items-center gap-2 rounded-md bg-muted/70 px-3 transition-[color,box-shadow] outline-none has-[:focus-visible]:border-ring has-[:focus-visible]:ring-[3px] has-[:focus-visible]:ring-ring/50">

...
import { BadgeCheckIcon, BellRingIcon, TimerIcon, Volume2Icon } from "lucide-react"
...
export function NotificationSettings({
    ...
    (task: Promise<void>) => {
      ...
      void task
        .catch((error: unknown) => {
          ...
          console.error("[dweis] update notification setting failed", error)
        })
  ...
  return (
    <>
      <SettingsItem
        title={t("settings.notificationSystemStatus")}
            ...
            onClick={() => {
              ...
              void onTest()
                .then((result) => {
                  ...
                  console.error("[dweis] test notification was not delivered", result)
                })
                .catch((error: unknown) => {
                  setLastTestResult({
                  ...
                  console.error("[dweis] test notification failed", error)
                })
      ...
      <SettingsItem
        title={t("settings.notificationBadge")}
        description={t("settings.notificationBadgeDescription")}
        icon={BadgeCheckIcon}
      >
        <Switch
    ...
    <Button
      ...
      onClick={() => {
        void onOpen().catch((error: unknown) => {
          ...
          console.error("[dweis] open system notification settings failed", error)
        })
      }}
    >
      {t(labelKey)}

...
export function useKnowledgeBases(enabled = true): UseKnowledgeBases {
  ...
  React.useEffect(() => {
    ...
    return observeKnowledgeBaseList({
      ...
      onError: (cause) => {
        console.error("[dweis] list knowledge bases failed", cause)
  ...
  const importKnowledgeBase = React.useCallback(
    async (sourcePath?: string, targetDirectory?: string) => {
      ...
      try {
        ...
        console.error("[dweis] import knowledge base failed", cause)
  ...
  const createFolder = React.useCallback(
    async (path: string) => {
      ...
      try {
        ...
        console.error("[dweis] create knowledge folder failed", cause)
  ...
  const loadChapters = React.useCallback(
    async (id: string, options?: { force?: boolean }) => {
      ...
      try {
        ...
        console.error("[dweis] read knowledge chapters failed", cause)
  ...
  const rename = React.useCallback(
    async (id: string, request: { authors?: string[]; fileName?: string; title?: string }) => {
      ...
      try {
        ...
        console.error("[dweis] rename knowledge base failed", cause)
  ...
  const move = React.useCallback(
    async (id: string, targetDirectory: string) => {
      ...
      try {
        ...
        console.error("[dweis] move knowledge base failed", cause)
  ...
  const removeFolder = React.useCallback(
    async (path: string) => {
      ...
      try {
        ...
        console.error("[dweis] remove knowledge folder failed", cause)
  ...
  const refresh = React.useCallback(
    async (id: string) => {
      ...
      try {
        ...
        console.error("[dweis] refresh knowledge base failed", cause)
  ...
  const remove = React.useCallback(
    async (id: string) => {
      ...
      try {
        ...
        console.error("[dweis] remove knowledge base failed", cause)
  ...
  const reveal = React.useCallback(
    async (id: string) => {
      try {
        ...
        console.error("[dweis] reveal knowledge base failed", cause)

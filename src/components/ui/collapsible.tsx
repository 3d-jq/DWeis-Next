...
function CollapsibleContent({ className, ...props }: React.ComponentProps<typeof CollapsiblePrimitive.CollapsibleContent>) {
  return (
    <CollapsiblePrimitive.CollapsibleContent
      ...
      className={cn(
        "overflow-hidden data-[state=open]:animate-[oo-collapsible-down_250ms_cubic-bezier(0.4,0,0.2,1)] data-[state=closed]:animate-[oo-collapsible-up_250ms_cubic-bezier(0.4,0,0.2,1)] motion-reduce:animate-none",
        className,
      )}
      {...props}
    />

...
const stateDir = path.join(repoRoot, ".dweis-dev")
const userDataDir = path.join(repoRoot, "dweis")
...
async function main(args: string[]): Promise<void> {
  ...
  console.log("[dweis] bootstrap complete")
  console.log(`[dweis] dev server port: ${config.devServerPort}`)
  console.log(`[dweis] user data dir: ${config.userDataDir}`)
  console.log("[dweis] run: corepack pnpm run dev:worktree")
}
...
export async function createBootstrapConfig(): Promise<BootstrapConfig> {
  ...
  return {
    devServerPort,
    env: {
      DWEIS_DEV_SERVER_PORT: String(devServerPort),

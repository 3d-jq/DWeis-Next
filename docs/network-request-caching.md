...
| Team skills             | Account and team                                                | 30 seconds in memory, max 50 entries, plus a 24-hour persistent localStorage snapshot (key `dweis.team-skill-cache.v3`) — the only persisted read cache | Team skill add/remove/association changes call `invalidateTeamSkillCache(accountId, teamId)` for targeted invalidation                                                                                                                                                                                                                                               |
...
| Billing overview        | Account (creator balance), team (Team plan/usage), stats period | 60 seconds                                                                                                                                              | Force refresh after top-up or any Team plan/seat change                                                                                                                                                                                                                                                                                                              |

...
> This document defines DWeis's long-term quality-improvement method, to be executed jointly by
...
## 3. DWeis's inviolable boundaries
...
3. Do not break the closed loop between OpenCode permission ask and DWeis's two-tier permission UI;
...
```text
You are running an evidence-driven quality-improvement loop in the DWeis repository.
